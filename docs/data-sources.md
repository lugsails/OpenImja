...
The Imja reference location and elevation in the configuration are transcribed from [ICIMOD's Imja Tsho story map](https://www.icimod.org/storymaps/imjatsho/). This is a reference point, not a surveyed shoreline. Product-specific terms and access conditions remain those of their respective providers.
